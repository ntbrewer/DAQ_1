...
struct mtc_par {
  int com0;                        // commands for programs to respond
  int com1;                        // commands for programs to respond
  int com2;                        // commands for programs to respond
...
#define FILEPATH "mtc.bin"
#define kick_conf "kick-u3.conf"
