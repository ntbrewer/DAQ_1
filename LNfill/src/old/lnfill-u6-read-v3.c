...
*/
    ...
    case 19:
      if (lnptr->com2 == 0) {
	printf (" Do you really want to toggle the LN Emergency Shutdwon ON?  y/n \n");
	scanf("%1s",&zzz);
	if (strcmp(zzz,"Y") == 0 || strcmp(zzz,"y") == 0) { 
	...
	printf (" Do you really want to toggle the LN Emergency Shutdwon OFF?  y/n \n");
	scanf("%1s",&zzz);
	if (strcmp(zzz,"Y") == 0 || strcmp(zzz,"y") == 0) { 
...
*/
  ...
  for (ii=0; ii<20; ii++){
    ...
    fprintf(ofile,"%2i    %3s      %i     %li    %3.0lf     %3.0lf     %2i      %2i      %3.0lf      %3.0lf     %3i \n", ii+1, 
...
void menu(){
  ...
  if (lnptr->com2 == 1) {
    printf ("19 - Shutdwon HV ON  |                         |             \n");
  }
  else {
    printf ("19 - Shutdwon HV OFF |                         |             \n");
  }
  printf ("---------------------------------------------------------------------------------------\n");
...
void parametersGe(int ii){
  ...
  while (jj != 99){
    ...
    printf ("3 - fill interval      | %li       | 13 - Ibar chan      | %i \n",lnptr->ge[ii].interval,lnptr->ge[ii].chanIbar + 1);
    printf ("4 - max fill interval  | %6.0lf    | 14 - next fill      | %li \n",lnptr->ge[ii].max,lnptr->ge[ii].next-time(NULL));//lnptr->ge[ii].next);
	...
	break;
      ...
      case 14:
	curtime=time(NULL);
	printf("Next fill occurs in ~%li seconds ? (< 0.99 do nothing) \n",lnptr->ge[ii].next-curtime);
